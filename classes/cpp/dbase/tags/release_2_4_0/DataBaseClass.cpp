...
//+----------------------------------------------------------------------------
//
// method : 		DbGetClassAttributeProperty2Cmd::DbGetClassAttributeProperty2Cmd()
// 
...
//
//-----------------------------------------------------------------------------
DbGetClassAttributeProperty2Cmd::DbGetClassAttributeProperty2Cmd(	const char		*name,
								Tango::CmdArgType in,
...
//+----------------------------------------------------------------------------
//
// method : 		DbGetClassAttributeProperty2Cmd::is_allowed()
// 
...
//
//-----------------------------------------------------------------------------
bool DbGetClassAttributeProperty2Cmd::is_allowed(Tango::DeviceImpl *device, const CORBA::Any &in_any)
{
...
//+----------------------------------------------------------------------------
//
// method : 		DbPutClassAttributeProperty2Cmd::DbPutClassAttributeProperty2Cmd()
// 
// description : 	constructor for the command of the DataBase.
//
// In : - name : The command name
...
//
//-----------------------------------------------------------------------------
DbPutClassAttributeProperty2Cmd::DbPutClassAttributeProperty2Cmd(	const char		*name,
								Tango::CmdArgType in,
				       			Tango::CmdArgType out,
								const char		*in_desc,
				       			const char		*out_desc,
...
//+----------------------------------------------------------------------------
//
// method : 		DbPutClassAttributeProperty2Cmd::is_allowed()
// 
// description : 	method to test whether command is allowed or not in this
//			state. In this case, the command is allowed only if
//			the device is in ON state
...
//
//-----------------------------------------------------------------------------
bool DbPutClassAttributeProperty2Cmd::is_allowed(Tango::DeviceImpl *device, const CORBA::Any &in_any)
{
		//	End of Generated Code
...
//+----------------------------------------------------------------------------
//
// method : 		DbGetDeviceAttributeProperty2Cmd::DbGetDeviceAttributeProperty2Cmd()
// 
// description : 	constructor for the command of the DataBase.
//
// In : - name : The command name
...
//
//-----------------------------------------------------------------------------
DbGetDeviceAttributeProperty2Cmd::DbGetDeviceAttributeProperty2Cmd(	const char		*name,
								Tango::CmdArgType in,
				       			Tango::CmdArgType out,
								const char		*in_desc,
				       			const char		*out_desc,
...
//+----------------------------------------------------------------------------
//
// method : 		DbGetDeviceAttributeProperty2Cmd::is_allowed()
// 
// description : 	method to test whether command is allowed or not in this
//			state. In this case, the command is allowed only if
//			the device is in ON state
...
//
//-----------------------------------------------------------------------------
bool DbGetDeviceAttributeProperty2Cmd::is_allowed(Tango::DeviceImpl *device, const CORBA::Any &in_any)
{
		//	End of Generated Code
...
//+----------------------------------------------------------------------------
//
// method : 		DbPutDeviceAttributeProperty2Cmd::DbPutDeviceAttributeProperty2Cmd()
// 
// description : 	constructor for the command of the DataBase.
//
// In : - name : The command name
...
//
//-----------------------------------------------------------------------------
DbPutDeviceAttributeProperty2Cmd::DbPutDeviceAttributeProperty2Cmd(	const char		*name,
								Tango::CmdArgType in,
				       			Tango::CmdArgType out,
								const char		*in_desc,
				       			const char		*out_desc,
...
//+----------------------------------------------------------------------------
//
// method : 		DbPutDeviceAttributeProperty2Cmd::is_allowed()
// 
// description : 	method to test whether command is allowed or not in this
//			state. In this case, the command is allowed only if
//			the device is in ON state
...
//
//-----------------------------------------------------------------------------
bool DbPutDeviceAttributeProperty2Cmd::is_allowed(Tango::DeviceImpl *device, const CORBA::Any &in_any)
{
		//	End of Generated Code
