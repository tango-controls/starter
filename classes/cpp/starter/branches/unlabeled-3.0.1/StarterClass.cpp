...
void StarterClass::attribute_factory(vector<Tango::Attr *> &att_list)
{
	...
	//	Attribute : ControlledRunningServers
	Tango::SpectrumAttr	*controlled_running_servers = 
		new Tango::SpectrumAttr("ControlledRunningServers", Tango::DEV_STRING, 50);
	Tango::UserDefaultAttrProp	controlled_running_servers_prop;
	controlled_running_servers_prop.set_label("Controlled running servers");
	controlled_running_servers_prop.set_description("Return the controlled running servers.");
	controlled_running_servers->set_default_properties(controlled_running_servers_prop);
	att_list.push_back(controlled_running_servers);

	//	Attribute : ControlledStoppedServers
	Tango::SpectrumAttr	*controlled_stopped_servers = 
		new Tango::SpectrumAttr("ControlledStoppedServers", Tango::DEV_STRING, 50);
	Tango::UserDefaultAttrProp	controlled_stopped_servers_prop;
	controlled_stopped_servers_prop.set_label("Controlled Stopped Servers");
	controlled_stopped_servers_prop.set_description("Return the controlled stopped servers.");
	controlled_stopped_servers->set_default_properties(controlled_stopped_servers_prop);
	att_list.push_back(controlled_stopped_servers);

	//	Attribute : AllRunningServers
	Tango::SpectrumAttr	*all_runnin_servers = 
		new Tango::SpectrumAttr("AllRunningServers", Tango::DEV_STRING, 50);
	Tango::UserDefaultAttrProp	all_runnin_servers_prop;
	all_runnin_servers_prop.set_label("All Running Servers");
	all_runnin_servers_prop.set_description("Return all the Running servers.\n");
	all_runnin_servers->set_default_properties(all_runnin_servers_prop);
	att_list.push_back(all_runnin_servers);

	//	Attribute : AllStoppedServers
	Tango::SpectrumAttr	*all_stopped_servers = 
		new Tango::SpectrumAttr("AllStoppedServers", Tango::DEV_STRING, 50);
	Tango::UserDefaultAttrProp	all_stopped_servers_prop;
	all_stopped_servers_prop.set_label("All Stopped Servers");
	all_stopped_servers_prop.set_description("Return all the Stopped servers.\n");
	all_stopped_servers->set_default_properties(all_stopped_servers_prop);
	att_list.push_back(all_stopped_servers);
