...
//
// $Log$
// Revision 3.45  2010/10/08 08:48:50  pascal_verdier
// Include files order changed.
//
// Revision 3.44  2010/09/21 12:18:58  pascal_verdier
// GPL Licence added to header.
//
// Revision 3.43  2010/02/09 15:09:49  pascal_verdier
// Define  _TG_WINDOWS_  replace WIN32.
// LogFileHome property added.
//
// Revision 3.42  2009/04/06 13:57:56  pascal_verdier
// IDL-4 (Tango-7) release.
//
// Revision 3.41  2008/12/12 13:29:56  pascal_verdier
// Log in file start and stop for servers and itself.
//
// Revision 3.40  2008/09/23 14:19:40  pascal_verdier
// Log files history added.
//
// Revision 3.39  2008/05/15 08:07:18  pascal_verdier
...
//
//-----------------------------------------------------------------------------
Starter::Starter(Tango::DeviceClass *cl,string &s):Tango::Device_4Impl(cl,s.c_str())
{
	starting = true;
	init_device();
}

Starter::Starter(Tango::DeviceClass *cl,const char *s):Tango::Device_4Impl(cl,s)
{
	starting = true;
	init_device();
}
